import time_axis_rcnn.model.time_segment_network.util.func.convolution_nd as convolution_nd
from chainer import initializers
from chainer import link
import time_axis_rcnn.model.time_segment_network.util.func.conv_nd as conv_nd
...
class ConvolutionND(link.Link):
    ...
    This link wraps the :func:`~chainer.func.convolution_nd` function and
    ...
    .. seealso::
        See :func:`~chainer.func.convolution_nd` for the definition of
        N-dimensional convolution. See
        :func:`~chainer.func.convolution_2d` for the definition of
