import time_axis_rcnn.model.time_segment_network.util.func.deconvolution_nd as deconvolution_nd
...
class DeconvolutionND(link.Link):
    ...
    This link wraps :func:`~chainer.func.deconvolution_nd` function and
    ...
    .. seealso::
       :func:`~chainer.func.deconvolution_nd`
