...
def assert_is_image(img, color=True, check_range=True):
    ...
    This legacy checks if a given image satisfies image format or not.
    If the image does not satifiy the format, this legacy raises an
    ...
    Args:
        ...
        check_range (bool): A boolean that determines whether the range
            ...
            Otherwise, this legacy does not check the range.
            The default value is :obj:`True`.
