...
def vis_label(
    ...
    Example:
        ...
        >>> from AU_rcnn.datasets import VOCSemanticSegmentationDataset
        >>> from AU_rcnn.datasets \
        ...     import voc_semantic_segmentation_label_colors
        >>> from AU_rcnn.datasets \
        ...     import voc_semantic_segmentation_label_names
        >>> from AU_rcnn.visualizations import vis_image
        >>> from AU_rcnn.visualizations import vis_label
