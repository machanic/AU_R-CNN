from AU_rcnn.visualizations.vis_image import vis_image
...
def vis_bbox(img, bbox, label=None, score=None, label_names=None, ax=None):
    ...
    Example:
        ...
        >>> from AU_rcnn.datasets import voc_detection_label_names
        >>> from AU_rcnn.visualizations import vis_bbox
