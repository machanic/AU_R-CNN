...
from AU_rcnn.links.model.ssd import Multibox
from AU_rcnn.links.model.ssd import Normalize
from AU_rcnn.links.model.ssd import SSD
...
class VGG16(chainer.Chain):
    ...
    * :class:`~AU_rcnn.links.model.ssd.Normalize` is \
...
class VGG16Extractor300(VGG16):
    ...
    This is a feature extractor for :class:`~AU_rcnn.links.model.ssd.SSD300`.
    This extractor is based on :class:`~AU_rcnn.links.model.ssd.VGG16`.
    """
...
class VGG16Extractor512(VGG16):
    ...
    This is a feature extractor for :class:`~AU_rcnn.links.model.ssd.SSD512`.
    This extractor is based on :class:`~AU_rcnn.links.model.ssd.VGG16`.
    """
...
class SSD300(SSD):
    ...
    This model uses :class:`~AU_rcnn.links.model.ssd.VGG16Extractor300` as
    ...
    Args:
       ...
       pretrained_model (str): The weight file to be loaded.
            ...
            * :obj:`'voc0712'`: Load weights trained on trainval split of \
                ...
                The conversion code is `AU_rcnn/examples/ssd/caffe2npz.py`.
...
class SSD512(SSD):
    ...
    This is a model of Single Shot Multibox Detector [#]_.
    This model uses :class:`~AU_rcnn.links.model.ssd.VGG16Extractor512` as
    its feature extractor.
