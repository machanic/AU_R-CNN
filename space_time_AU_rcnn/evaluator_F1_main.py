...
def extract_mode(model_file_name):
    ...
    if matcher:
        ...
        use_conv_lstm = True if matcher.group(10) == "convlstm" else False
        ...
        return_dict["use_conv_lstm"] = use_conv_lstm
...
def main():
    ...
    use_conv_lstm = mode_dict["use_conv_lstm"]
    ...
    video_dataset = AU_video_dataset(au_image_dataset=img_dataset,
                                        sample_frame=sample_frame, train_mode=False,
