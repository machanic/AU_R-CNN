...
class ResRoIHead(chainer.Chain):
    ...
    def __init__(self, roi_size, spatial_scale, n_class, classify_mode=False, use_roi_align=False, use_feature_map_res45=False,
        ...
        self.use_feature_map_res45 = use_feature_map_res45
    ...
    def __call__(self, x, rois, roi_indices):
        ...
        if self.use_feature_map_res5:
            return h
        elif self.use_feature_map_res45:
            scale_16 = pool
            scale_32 = h
